...
workflow test_single_end {
    ...
    bowtie2_index_path = file(params.goodwright_test_data['aligners']['hs_smallrna_bowtie2_index_tar'], checkIfExists: true)
    ...
    ch_bt2_index  = UNTAR_BT2  ( [ [:], bowtie2_index_path ] ).untar
