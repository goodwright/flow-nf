...
include { BEDTOOLS_SHIFT                               } from '../../../modules/flow-nf/bedtools/shift/main.nf'
...
include { LINUX_COMMAND as SELECT_BED_POS              } from '../../../modules/flow-nf/linux/command/main.nf'
include { LINUX_COMMAND as SELECT_BED_NEG              } from '../../../modules/flow-nf/linux/command/main.nf'
include { LINUX_COMMAND as MERGE_AND_SORT              } from '../../../modules/flow-nf/linux/command/main.nf'
include { LINUX_COMMAND as CROSSLINK_COVERAGE          } from '../../../modules/flow-nf/linux/command/main.nf'
include { LINUX_COMMAND as CROSSLINK_NORMCOVERAGE      } from '../../../modules/flow-nf/linux/command/main.nf'
